...
import appRequest, { GetVerifyDemandNoticePayment } from "api";
...
const DemandNoticePaymentSuccessPage = () => {
  ...
  const [paymentData, setPaymentData] = useState<
    typeof GetVerifyDemandNoticePayment.Res["data"] | null
  >(null);
  ...
  const verify = useCallback(async () => {
    ...
    try {
      const res = await appRequest.get<typeof GetVerifyDemandNoticePayment.Res>(
        GetVerifyDemandNoticePayment.Route,
  ...
  const goBills = () => navigate(ROUTES.communityDues.fullPath);
        ...
        <ContentCard>
          ...
          <div style={{ width: "100%" }}>
            <DetailRow>
              ...
              <DetailValue>{paymentData.invoice_no}</DetailValue>
            </DetailRow>
            <DetailRow>
            ...
            <DetailRow>
              ...
              <DetailValue>{paymentData.invoice_status}</DetailValue>
            </DetailRow>
          </div>
          ...
          >
            <Button text="View Bills" onClick={goBills} />
    ...
    <PageWrapper>
      <ContentCard>
        ...
        <Typography variant="bodyBig">
          ...
          Please check your bills page shortly.
        </Typography>
        <div
          style={{
            display: "flex",
...
export default DemandNoticePaymentSuccessPage;
